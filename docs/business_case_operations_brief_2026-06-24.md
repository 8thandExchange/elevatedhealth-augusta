...
- **Retatrutide posture (resolved 2026-06-25):** Active gated GLP-1 option ($499/mo fill SKU) under Dr. Akers — physician-selected, full GLP-1 consent Section 11A. Not engine-hard-blocked; not advertised. See `src/lib/therapyCatalog.ts`.
