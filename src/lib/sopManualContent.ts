...
export const UPSELL_MATRIX: UpsellRow[] = [
  ...
  },
  {
    ...
    offer: "Expanded panel if GLP-1 / metabolic candidacy",
...
export const CHARGE_CHECKPOINTS: ChargeCheckpoint[] = [
  ...
  },
  {
    ...
    amount: "$199 or $299",
    verify: "Panel matches protocol (TRT/HRT → Comprehensive; GLP-1/Metabolic → Expanded)",
  },
  {
    step: "C-03",
...
export const SOP_ALGORITHMS: SOPAlgorithm[] = [
  {
    ...
    steps: [
      ...
      },
      {
        step: "4.6",
        phase: "Provider review",
        if: "Advanced metabolic / peptide stack candidacy + consents on file",
        then: "Approve ELEVATED METABOLIC RECOMPOSITION → ALGO-006 phased protocol.",
      },
      {
        step: "4.7",
        phase: "Provider review",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        step: "6",
        if: "GLP-1 candidacy (semaglutide or tirzepatide)",
        then: "Enroll ELEVATED GLP-1 ($349/mo).",
      },
      {
        step: "7",
  ...
  {
    id: "ALGO-006",
    title: "Metabolic Recomposition Stack enrollment",
    purpose: "Phased 90-day protocol with GC sourcing and consents.",
    ...
    steps: [
      ...
      { step: "7", action: "Phase 4 (optional): AOD / SLU / 5-amino per physician — mostly FCC lines." },
      { step: "8", action: "Route GC lines through GC network; FCC for Phase 4 adjuncts.", stop: true },
    ],
  },
  {
    id: "ALGO-007",
