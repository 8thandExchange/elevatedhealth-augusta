...
export const PROVIDER_PROTOCOL_ALGORITHMS: ProviderProtocolAlgorithm[] = [
  ...
  {
    slug: "retatrutide-gated-glp1",
    displayName: "Retatrutide (investigational, gated GLP-1 — provider-only)",
    startDose: "Retatrutide 0.5 mg weekly; titrate slowly per tolerance",
    escalationSchedule: "Titrate q1–2 weeks to lowest effective dose — physician-only, gated",
    frequency: "Weekly subQ",
    route: "Subcutaneous",
    cycleLength: "Reassess per physician",
    holdRules: ["Hold for uncontrolled nausea", "Hold for gallbladder symptoms acute"],
    stopRules: ["Suspected pancreatitis", "Pregnancy", "Physician discontinuation"],
    monitoringLabs: ["Expanded panel baseline", "Quarterly CMP", "A1C / lipids per protocol"],
    adverseEffectMonitoring: ["GI tolerance", "Injection site", "HR/BP (glucagon activity)"],
    refillRules: "Gated, physician-selected only — never advertised, never the lead",
    followUpInterval: "Biweekly weeks 1–4, then monthly",
    supplierVialOption: "GC retatrutide 20 mg; FCC backup",
    documentationRequired: ["GLP-1 consent (Section 11A)", "Investigational acknowledgment"],
  },
  {
  ...
  {
    slug: "male-trt-initiation-transdermal-cream",
    displayName: "Male TRT Initiation (Transdermal Testosterone Cream)",
    startDose: "50–100 mg testosterone daily transdermal (physician-titrated to labs)",
    escalationSchedule: "Adjust q6–8 weeks per total T, free T, E2, hematocrit",
    frequency: "Daily",
    ...
    adverseEffectMonitoring: ["HCT", "E2", "Acne", "Mood", "Transfer to partners"],
    refillRules: "Included in ELEVATED TRT or single cream fill",
    followUpInterval: "6–8 weeks early; quarterly stable",
    supplierVialOption: "Custom Pharmacy of Evans testosterone cream (daily application)",
    documentationRequired: ["Hormone therapy consent", "Application site teaching"],
  },
  {
