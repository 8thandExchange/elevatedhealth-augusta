...
export const DOSING_PROTOCOLS: Record<string, DosingProtocol> = {
  ...
  bpc157: {
    ...
    titration: [
      { weeks: "1–2", dose: "250 mcg daily", syringeNote: "Loading optional" },
      { weeks: "3–12", dose: "500 mcg daily" },
    ],
    maintenanceDose: "500 mcg daily",
    cycleWeeks: "6–12 weeks on, 4–6 weeks off",
    patientExplanation:
      "A recovery peptide your provider may select to support tissue recovery after injury or intense training.",
  ...
  tb500: {
    ...
    frequency: "Weekly",
    titration: [
      { weeks: "1–6", dose: "2–2.5 mg subQ weekly (loading)" },
      { weeks: "7–12", dose: "2 mg weekly maintenance if extended" },
    ],
    maintenanceDose: "2 mg weekly",
    cycleWeeks: "6–12 weeks typical; physician-defined",
    patientExplanation:
      "A weekly recovery peptide your provider may select for tissue mobility and training recovery support.",
    staffNotes: [
      "Cat 2 research peptide consent.",
      "WADA prohibited — disclose to competitive athletes.",
    ],
    consents: ["research_peptide"],
  },
  pt141: {
