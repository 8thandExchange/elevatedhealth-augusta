...
export const CLINICAL_OPTIMIZATION_CATALOG: ClinicalOptimizationItem[] = [
  ...
  },
  {
    ...
    internal_notes: "Alternate recovery option when physician selects PDA over injectable recovery peptides.",
    regulatory_notes: "Provider-selected alternate after Recovery Peptide Review.",
    public_description:
      "Oral recovery support — provider-selected alternate when clinically appropriate after Recovery Peptide Review.",
    staff_description: "Recovery Peptide Review lane; alternate to BPC/TB when physician prefers PDA.",
