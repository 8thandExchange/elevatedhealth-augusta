...
export const CLINICAL_OPTIMIZATION_CATALOG: ClinicalOptimizationItem[] = [
  ...
  fromCatalogKey("retatrutide-provider-directed", MEDICATION_FILLS.retatrutide.name, "glp1_weight_loss", "retatrutide", {
    ...
    consent_type: "glp1",
    elevated_program_key: "glp1",
    internal_notes: "Investigational, gated, physician-selected ONLY within the GLP-1 lane (consent Section 11A, go-live 2026-06-21). Not advertised, not casual à la carte.",
    public_description: "Investigational triple agonist — gated, physician-selected only within the GLP-1 program when approved.",
    provider_algorithm: { protocolSlug: "retatrutide-gated-glp1" },
  }),
  // Peptides
  ...
  },
  {
    ...
    route: "subQ",
    dosage_form: "injectable",
    patient_price_cents: nonMemberPriceCents(CATALOG.bpc157),
    member_price_cents: memberPriceCents(CATALOG.bpc157),
  ...
  },
  {
    ...
    route: "subQ",
    dosage_form: "injectable",
    patient_price_cents: nonMemberPriceCents(CATALOG.tb500),
    member_price_cents: memberPriceCents(CATALOG.tb500),
