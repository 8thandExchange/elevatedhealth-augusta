...
export const FORMULARY_ECONOMICS_CATALOG: FormularyEconomicsLine[] = [
  ...
  {
    itemCode: "HORM-TEST-CREAM-MEN",
    label: "Testosterone cream (men)",
    category: "hormone",
    primarySupplier: "custom_pharmacy_evans",
    primaryCostCents: 3000,
    primaryCostUnit: "30g/mo",
    alternateSupplier: "gc",
    alternateCostCents: GC_WHOLESALE_CENTS.testosteroneCream30ml,
    clientPriceCents: 0,
    fulfillmentPharmacySlug: VENDOR_SLUGS.customPharmacyEvans,
    publicMenu: false,
    notes: "Cream is the standard men's TRT (no injectable TRT offered). Included in ELEVATED TRT. Primary cost is GC benchmark ($30/30g); confirm Custom Pharmacy Evans local price. Empower alt $52.80/30mL.",
  },
  {
    itemCode: "IV-MYERS",
