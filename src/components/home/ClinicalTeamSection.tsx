  ...
  return (
    <section ref={ref} className="section-band-surface">
      <div className="container mx-auto px-6 lg:px-8 space-y-20 md:space-y-28">
            ...
            <div className="order-2">
              ...
              <div className="space-y-5 font-jost font-light text-base text-foreground/90 leading-relaxed">
                <p>
                  ...
                  under physician-authorized standing orders with direct access to your medical
                  director when your case needs physician review.
                </p>
                <p>
        ...
        {/* Physician-owned leadership — secondary to Caroline */}
        {hasPhysician && (
          <div
            className={`max-w-5xl mx-auto grid gap-12 lg:gap-20 items-center md:grid-cols-2 ${revealClasses.fadeUp(isVisible)}`}
          ...
          >
            <div className="order-2 md:order-1">
              ...
              <div className="space-y-5 font-jost font-light text-base text-foreground/90 leading-relaxed">
                <p>
                  ...
                  and supervised by Dr. Akers. Hormone optimization, peptide medicine, GLP-1
                  weight management, and IV formulary — physician-owned, not franchise-operated.
                </p>
                <p>
                  Caroline handles day-to-day clinical care; Dr. Akers reviews labs, signs
                  protocols, and escalates when your case needs physician decision-making.
                </p>
            ...
            <MarketingImage
              ...
              alt="Dr. Troy Akers — Medical Director, Elevated Health Augusta"
