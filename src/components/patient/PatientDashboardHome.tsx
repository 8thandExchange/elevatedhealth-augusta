  ...
  const setupSteps: SetupStep[] = useMemo(
    () => [
      ...
      },
      {
        ...
        actionLabel: wellnessPaid && !hasUpcomingVisit ? "Schedule" : undefined,
        actionPath: wellnessPaid && !hasUpcomingVisit ? "/schedule-consult" : undefined,
      },
      {
        id: "gfe",
        label: "Medical clearance (when requested)",
        done: gfeComplete,
