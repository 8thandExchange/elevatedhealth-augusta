-- business_admin: read patients (schedule search + business dashboard blockers).
-- Bootstrap Dennis Williams portal account if missing.
...
DO $$
DECLARE
  _email constant text := 'drdwmd@pmrehab.net';
  _uid uuid;
...
BEGIN
  ...
  IF _uid IS NULL THEN
    ...
    INSERT INTO auth.users (
      ...
      '{"full_name":"Dennis Williams","invited_roles":["business_admin"]}'::jsonb,
      timezone('utc', now()),
      timezone('utc', now()),
      '',
      '',
