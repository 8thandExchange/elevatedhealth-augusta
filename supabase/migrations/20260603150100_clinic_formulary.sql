...
DROP POLICY IF EXISTS "Staff and admins can update clinic formulary" ON public.clinic_formulary;
...
DROP POLICY IF EXISTS "Admins can delete clinic formulary" ON public.clinic_formulary;
